...
function getMatchupsByWeek(leagueId, week) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, fetch_1["default"])("".concat(variables_1.baseUrl, "/league/").concat(leagueId, "/matchups/").concat(week))];
...
function getWinnersBracket(leagueId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, fetch_1["default"])("".concat(variables_1.baseUrl, "/league/").concat(leagueId, "/winners_bracket"))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function getLosersBracket(leagueId) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, fetch_1["default"])("".concat(variables_1.baseUrl, "/league/").concat(leagueId, "/losers_bracket"))];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
